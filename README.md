...
- به‌طور خودکار برای بارگذاری همه‌ی فالویینگ‌ها اسکرول می‌کند.
...
1- روی آیکون اکستنشن استخراج فالویینگ اینستاگرام کلیک کنید تا رابط کاربری در یک پنجره پاپ‌آپ نمایش داده شود. برای شروع استخراج روی دکمه "Click to Start Scraping" کلیک کنید
